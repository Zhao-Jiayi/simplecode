...
from retinanet import model,modeldfl
...
def main(args=None):
    ...
    # Create the model
    if parser.depth == 18:
        retinanet = modeldfl.resnet18(num_classes=19, pretrained=False)
    elif parser.depth == 34:
        retinanet = model.resnet34(num_classes=19, pretrained=False)
    elif parser.depth == 50:
        retinanet = modeldfl.resnet50(num_classes=19, pretrained=False)
